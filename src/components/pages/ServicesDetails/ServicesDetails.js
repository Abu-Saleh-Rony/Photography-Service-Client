...
import DetailReview from "../UserReview/UserReview";
...
const ServicesDetails = () => {
    ...
    const handleDelete = (id) => {
        ...
        if (agree) {
            fetch(`https://photography-service-server-abu-saleh-rony.vercel.app/feedback/${id}`, {
                method: "DELETE",
            })
                .then((res) => res.json())
                .then((data) => {
    ...
    const handleFeedback = (e) => {
        ...
        fetch("https://photography-service-server-abu-saleh-rony.vercel.app/feedback", {
            method: "POST",
            headers: {
                            ...
                            <div className="hero min-h-screen bg-base-200">
                                <div className="hero-content flex-col lg:flex-row-reverse">
                                    <div className="text-center lg:text-left">
                                        ...
                                        <p className="py-6">
                                            If you love to amazing photography works please leave a review to encourage us.
