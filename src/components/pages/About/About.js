        ...
        <div className="relative flex flex-col-reverse py-16 lg:py-0 lg:flex-col">
            <div className="w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:py-20 lg:max-w-screen-xl">
                <div className="mb-0 lg:max-w-lg lg:pr-8 xl:pr-6">
                    <h2 className="mb-5 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none md:text-center">
                        ...
                        This is a photography service provider
                    </h2>
            ...
            <div className="inset-y-0 top-0 right-0 w-full max-w-xl px-4 mx-auto mb-6 md:px-0 lg:pl-8 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-1/2 lg:max-w-full lg:absolute xl:px-0">
                <img
                    ...
                    src="https://assets.vogue.in/photos/606476e18f6eb74646570ec3/1:1/w_639,h_639,c_limit/Rhea%20and%20Avik%20Chatterjee%E2%80%99s%20wedding%202.jpg"
                    alt=""
                />
            </div>
        </div>
